...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Tightening</h1>
        <a href="/tightening" class="btn btn-danger">
    ...
    <div class="card">
        <div class="card-body shadow">
            <form method="POST" action="{{route('tightening.store')}}" enctype="multipart/form-data">
                @csrf
